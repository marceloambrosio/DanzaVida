...
urlpatterns = [
    ...
    path('cuota_especial_mostrar/', login_required(cuota_especial_mostrar), name='cuota_especial_mostrar'),
    path('cuota_especial_confirmar/', login_required(confirmar_cuota_especial), name='cuota_especial_confirmar'),
    path('caja_create', login_required(CajaCreateView.as_view()), name='caja_create'),
    path('caja_list/<int:periodo_id>/', login_required(CajaListView.as_view()), name='caja_list'),
    ...
    path('caja_cierre/<int:pk>', login_required(cerrar_caja), name='caja_cierre'),
    path('caja_periodo/', login_required(CajaPeriodoListView.as_view()), name='caja_periodo'),
    path('caja_periodo_pdf/<int:periodo_id>', login_required(CajaPeriodoPDFView.as_view()), name='caja_periodo_pdf'),
